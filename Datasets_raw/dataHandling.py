...
class DataHandler(object):
    ...
    def promptCSVCreation(dataset):
        print(f"Error: {dataset}-Dataset has not yet been converted to .csv format.\n",
            "Please run file Datasets_raw/dataHandling.py as main: \n",
              "1. Navigate to InductiveDialogueGraph\n",
              "2. Run the command: \n",
              "python -m Datasets_raw.dataHandling")
    ...
    def swda2csv(self):
        ...
        file_names = glob.glob("Datasets_raw/swda/swda/sw**utt/*")
        ...
        for i in tqdm(range(len(file_names))):
            ...
            dialogue = Transcript(id, 'Datasets_raw/swda/swda/swda-metadata.csv')
